...
const initialTags: TagData[] = [
    { id: '1', text: 'AI', bgColor: 'bg-sky-50', textColor: 'text-sky-700', borderColor: 'border-sky-200', removeIconColor: 'stroke-sky-700' },
    { id: '2', text: 'Tech', bgColor: 'bg-indigo-50', textColor: 'text-indigo-700', borderColor: 'border-indigo-200', removeIconColor: 'stroke-indigo-700' },
        ...
        <div className="flex flex-col items-center w-full mt-24 mb-9 max-md:max-w-full">
            <div className="flex flex-col w-full items-center gap-6">
                <div className="flex flex-col font-semibold text-center">
                    <h2 className="text-base text-violet-700">
