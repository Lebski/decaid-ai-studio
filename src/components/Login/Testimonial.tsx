  ...
  return (
    <section className="relative flex-none w-1/2 min-h-screen overflow-hidden">
      ...
      <div className="relative flex flex-col justify-end h-full p-14 z-10">
        ...
        <div>
          <h2 className="text-3xl font-semibold leading-10 text-white mb-3">Amélie Laurent</h2>
          <div className="flex justify-between items-end">
            <div className="text-white">
              <p className="text-lg font-semibold leading-7">Lead Designer, Layers</p>
              <p className="text-base font-medium leading-6">Web Development Agency</p>
            </div>
            <div className="flex gap-4">
              <TestimonialSliderButton variant="prev" onClick={handlePrevClick} />
              <TestimonialSliderButton variant="next" onClick={handleNextClick} />
            </div>
          </div>
        </div>
      </div>
