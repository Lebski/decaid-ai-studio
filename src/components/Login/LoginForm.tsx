  ...
  return (
    <div className="flex flex-col max-w-[360px] w-[360px]">
      ...
      <form
        ...
        className="flex flex-col mt-8 w-full rounded-xl"
      >
        <InputField
          label="Email"
          type="email"
        ...
        <div className="flex mt-6 w-full">
          <div className="flex flex-1 shrink gap-2 items-start my-auto basis-0 min-w-[240px]">
            <label className="flex items-center cursor-pointer">
              ...
              <span className="ml-2 text-sm font-medium leading-5 text-slate-700">
          ...
          <a
            href="#"
            className="overflow-hidden gap-1.5 self-stretch h-full text-sm font-semibold leading-5 text-violet-700"
            onClick={(e) => {
              e.preventDefault();
              onForgotPassword();
            }}
