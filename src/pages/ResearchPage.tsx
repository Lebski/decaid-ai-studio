...
import SourcesSection, {
  Integration
} from 'components/Research/SourcesSection';
...
const integrationData: Integration[] = [
  ...
  },
  {
    ...
    description:
      'AI for Non-Techies — Learn how AI tools can transform your productivity',
    isActive: false,
    category: 'tech'
  },
  {
    ...
    imageSrc: zeitIcon,
    description:
      'Die Zeit is a German national weekly newspaper published in Hamburg in Germany.',
    isActive: true,
    category: 'news'
  },
  {
    ...
    description:
      'Die erste Adresse für Nachrichten und Information: An 365 Tagen im Jahr, rund um die Uhr aktualisiert.',
    isActive: true,
    category: 'news'
  },
  {
  ...
  },
  {
    ...
    description:
      'The Guardian is a British daily newspaper. It was founded in 1821 as The Manchester Guardian.',
    isActive: true,
    category: 'news'
  },
  {
...
const ResearchPage: React.FC = () => {
  ...
  const [integrations, setIntegrations] =
    useState<Integration[]>(integrationData);
  ...
  const handleSearchStarted = (searchTerm: string, tagValues: string[]) => {
    ...
    navigate(
      `/research/results?search=${encodedSearch}&tags=${encodedTags}&sources=${encodedSources}`
    );
  };
