...
const HomePage: React.FC = () => {
  ...
  const inspirationCards: InspirationCardProps[] = [
    ...
    },
    {
      ...
      description:
        'Quickly generate comprehensive meeting summaries that capture key points and action items',
    ...
    },
    {
      ...
      description:
        'Effortlessly transform the latest news into engaging social media content tailored for your audience',
    ...
    },
    {
      ...
      description:
        'Automatically create detailed project briefings to keep your team informed and aligned',
      tags: ['Management', 'Leadership'],
    ...
    },
    {
      ...
      description:
        'Convert current news articles into ready-to-record podcast scripts for dynamic content creation',
    ...
    },
    {
      ...
      description:
        'Accurately transcribe voicemail messages into organized notes for easy reference and follow-up',
